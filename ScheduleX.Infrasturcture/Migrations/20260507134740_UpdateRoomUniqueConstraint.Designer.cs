...
namespace ScheduleX.Infrastructure.Migrations
{
    ...
    [Migration("20260507134740_UpdateRoomUniqueConstraint")]
    partial class UpdateRoomUniqueConstraint
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ScheduleX.Core.Entities.Division", b =>
                {
                    ...
                    b.Property<int?>("TTCoordinatorId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ScheduleX.Core.Entities.Room", b =>
                {
                    ...
                    b.HasIndex("DepartmentId", "RoomName")
                        .IsUnique();
            ...
            modelBuilder.Entity("ScheduleX.Core.Entities.Division", b =>
                {
                    ...
                    b.HasOne("ScheduleX.Core.Entities.User", "TTCoordinator")
                        .WithMany()
                        .HasForeignKey("TTCoordinatorId")
                        .OnDelete(DeleteBehavior.Restrict);
